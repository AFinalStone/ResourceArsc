...
public class ResourceArscFileParser {
    ...
    private final static String ARSC_FILE_IN_PATH = "ResourceArsc/res/resources_01.arsc";
    private final static String ARSC_FILE_OUT_PATH = "ResourceArsc/res/resources.arsc";

    public static void main(String[] args) {
        ResFile resFile = parseFile(ARSC_FILE_IN_PATH);
